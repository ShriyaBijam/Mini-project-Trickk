...
class DecryptImages(models.Model):
    to_be_hidden = models.ImageField(null=True, blank=True, upload_to=user_directory_path)
    used_to_hide = models.ImageField(null=True, blank=True, upload_to=user_directory_path)
    encrypted_picture = models.ImageField(upload_to=user_directory_path)
    owner = models.ForeignKey(User, related_name="decryptImages", on_delete=models.CASCADE, null=True)
